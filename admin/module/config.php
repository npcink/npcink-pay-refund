...
function sandbox_menu_page_displays() {
	...
	<h2><?php echo esc_html(get_admin_page_title()); ?></h2>
        ...
        <ul>
            <li>1、统计数据通过JSON格式保存在 /inc/data/ 文件夹下，文件名随机生成</li>
            <li>2、微信的KEY通过pem格式保存在 /inc/cert/ 文件夹下，文件名随机生成</li>
            <li>3、因为技术问题，微信退款是在点击退款按钮后进行记录的，可能有重复，还请注意</li>
            <li>4、因为安全问题，仅支持7天内的订单进行退款操作，还请注意</li>
            <li>5、退款原因仅自己可见</li>
            <li>6、请勿关闭 REST API 功能</li>
        </ul>
